            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('games.update', $game) }}" class="space-y-6">
                    ...
                    <div class="max-w-xl">
                        ...
                        <x-text-input name="name" type="text" class="mt-1 block w-full" :value="old('name', $game->name)" required autofocus />
                            ...
                            <div class="w-full">
                                <label class="inline-flex items-center">
                                    <input
                                        ...
                                        name="players[]"
                                        value="{{ $id }}"
                                        @checked(in_array($id, old('players', $game->users->pluck('id')->toArray())))
                                    >
                    ...
                    <div class="flex items-center gap-4">
                        <x-primary-button>{{ __('Update :name', ['name' => __('game')]) }}</x-primary-button>
